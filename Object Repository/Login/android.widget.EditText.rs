...
<MobileElementEntity>
   ...
   <locator>new UiSelector().className(&quot;android.widget.EditText&quot;).packageName(&quot;com.mhealthbank&quot;).enabled(true).clickable(true).longClickable(true).checkable(false).checked(false).focusable(true).focused(false).scrollable(false).selected(false).index(4)</locator>
